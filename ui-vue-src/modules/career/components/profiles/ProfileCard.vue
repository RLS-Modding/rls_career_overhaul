<template>
  <div
    ...
    <div class="pc-image" :style="bgStyle">
      ...
      <div class="pc-header">
        <div class="pc-name">{{ $ctx_t(id) }}</div>
    ...
    <div :class="['pc-drawer', { 'pc-drawer--open': showBody }]">
      <div ref="bodyRef" class="pc-body" v-bng-on-ui-nav:menu,back="goBack">
          <div v-if="isManage && currentMenu === MENU_ITEMS.RENAME" class="pc-manage-section">
            <BngInput
              v-model="saveName"
...
const showBody = computed(() => hovered.value || isManage.value)
...
const canDeactivate = () => !isManage.value
const canBubbleEvent = e => e.detail.name === "menu" && !isManage.value
